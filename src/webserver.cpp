 ...
 void handleUpdateSettings() {
   if (server.hasArg("plain")) {
     ...
     if (!error) {
       ...
       if (doc.containsKey("doorAutoMode")) settings.doorAutoMode = doc["doorAutoMode"].as<bool>();
       if (doc.containsKey("doorOpenHour")) settings.doorOpenHour = doc["doorOpenHour"].as<int>();
       if (doc.containsKey("doorCloseHour")) settings.doorCloseHour = doc["doorCloseHour"].as<int>();
       if (doc.containsKey("lightThreshold")) settings.lightThreshold = doc["lightThreshold"].as<int>();
       if (doc.containsKey("feederAutoMode")) settings.feederAutoMode = doc["feederAutoMode"].as<bool>();
       if (doc.containsKey("feedHour1")) settings.feedHour1 = doc["feedHour1"].as<int>();
       if (doc.containsKey("feedHour2")) settings.feedHour2 = doc["feedHour2"].as<int>();
       if (doc.containsKey("feedAmount")) settings.feedAmount = doc["feedAmount"].as<int>();
